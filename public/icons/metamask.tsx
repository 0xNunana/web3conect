// src/components/icons/Metamask.tsx
import { SVGProps } from "react";

interface MetamaskIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

export const MetamaskIcon = ({ size = 24, ...props }: MetamaskIconProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <defs>
        <style>
          {`
            .metamask-a{fill:#e2761b;stroke:#e2761b;}
            .metamask-b{fill:#e4761b;stroke:#e4761b;}
            .metamask-c{fill:#d7c1b3;stroke:#d7c1b3;}
            .metamask-d{fill:#233447;stroke:#233447;}
            .metamask-e{fill:#cd6116;stroke:#cd6116;}
            .metamask-f{fill:#e4751f;stroke:#e4751f;}
            .metamask-g{fill:#f6851b;stroke:#f6851b;}
            .metamask-h{fill:#c0ad9e;stroke:#c0ad9e;}
            .metamask-i{fill:#161616;stroke:#161616;}
            .metamask-j{fill:#763d16;stroke:#763d16;}
            .metamask-a,.metamask-b,.metamask-c,.metamask-d,.metamask-e,
            .metamask-f,.metamask-g,.metamask-h,.metamask-i,.metamask-j{
